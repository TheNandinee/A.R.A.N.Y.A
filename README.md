...
We welcome contributions from geospatial engineers, ML researchers, policy experts, and frontend developers.

**Current priority areas:**
- Bi-temporal change detection model benchmarking
- Indian regulatory document corpus curation
...
- [x] Research landscape survey (NDVI, CNN segmentation, change detection)
- [ ] Sentinel-2 data pipeline and preprocessing
- [ ] Land cover segmentation model (DeepLabv3+)
- [ ] Bi-temporal change detection module
- [ ] Risk scoring engine
- [ ] Compliance intelligence layer (policy RAG)
- [ ] Real-time dashboard (Leaflet + React)
- [ ] Streaming simulation for demo
- [ ] Drone verification module (Phase 2)
